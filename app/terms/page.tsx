        ...
        <div className="space-y-8">
          ...
          <section className="glass rounded-2xl border border-border/50 p-6 lg:p-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              By accessing or using Careerhub ("the Platform"), you agree to be bound by these Terms of 
          ...
          <section className="glass rounded-2xl border border-border/50 p-6 lg:p-8">
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>You agree to use Careerhub only for lawful purposes and in accordance with these Terms. You agree NOT to:</p>
          ...
          <section className="glass rounded-2xl border border-border/50 p-6 lg:p-8">
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                Careerhub is designed for professional discussions. While we respect anonymity, 
          ...
          <section className="glass rounded-2xl border border-border/50 p-6 lg:p-8">
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                ...
                and functionality are owned by Careerhub and are protected by international copyright, 
                trademark, and other intellectual property laws.
              </p>
              <p>
                By posting content on Careerhub, you grant us a non-exclusive, worldwide, royalty-free 
          ...
          <section className="glass rounded-2xl border border-border/50 p-6 lg:p-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              IN NO EVENT SHALL Careerhub, ITS DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE FOR ANY 
          ...
          <section className="glass rounded-2xl border border-border/50 p-6 lg:p-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              jurisdiction in which Careerhub operates, without regard to its conflict of law provisions. 
