...
export async function POST(request: NextRequest) {
  try {
    ...
    const mailOptionsToAdmin = {
      ...
      subject: `[Careerhub Contact] ${subject} - from ${name}`,
      html: `
        <!DOCTYPE html>
        <html>
        <head>
                  ...
                  <tr>
                    <td style="padding: 20px 30px; border-top: 1px solid rgba(255, 255, 255, 0.1); text-align: center;">
                      <p style="margin: 0; color: #666; font-size: 12px;">
                        This message was sent from the Careerhub contact form.<br>
...
Received at ${new Date().toLocaleString()}
    ...
    const mailOptionsToSender = {
      from: emailUser,
      to: email,
      subject: `Thank you for contacting Careerhub!`,
      html: `
        <!DOCTYPE html>
        <html>
        <head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background: linear-gradient(135deg, rgba(18, 84, 217, 0.1) 0%, rgba(10, 22, 40, 0.9) 100%); border-radius: 16px; border: 1px solid rgba(18, 84, 217, 0.2); overflow: hidden;">
                  ...
                  <tr>
                    <td style="padding: 30px;">
                      ...
                      <p style="margin: 0 0 20px 0; color: #e0e0e0; font-size: 16px; line-height: 1.6;">
                        Thank you for reaching out to Careerhub! We've received your message and our team will review it shortly.
                      </p>
                      <p style="margin: 0 0 20px 0; color: #e0e0e0; font-size: 16px; line-height: 1.6;">
                      ...
                      <p style="margin: 0; color: #888; font-size: 14px;">
                        In the meantime, feel free to explore our community at <a href="https://www.Careerhub.tech" style="color: #5b9aff; text-decoration: none;">Careerhub.tech</a>
                      </p>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td style="padding: 20px 30px; border-top: 1px solid rgba(255, 255, 255, 0.1); text-align: center;">
                      <p style="margin: 0 0 10px 0; color: #ffffff; font-weight: 600;">
                        Careerhub - Speak Freely, Stay Anonymous
                      </p>
                      <p style="margin: 0; color: #666; font-size: 12px;">
                        <a href="https://www.Careerhub.tech/privacy" style="color: #5b9aff; text-decoration: none;">Privacy</a> • 
                        <a href="https://www.Careerhub.tech/terms" style="color: #5b9aff; text-decoration: none;">Terms</a> • 
                        <a href="https://www.Careerhub.tech" style="color: #5b9aff; text-decoration: none;">Website</a>
                      </p>
                    </td>
                  </tr>
                </table>
