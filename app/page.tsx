    ...
    <main className="min-h-screen bg-background bg-pattern overflow-hidden">
      ...
      <section className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32 text-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-border/50 mb-8 fade-in">
          <Image src="/icon.png" alt="Careerhub" width={20} height={20} className="rounded" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">
              Why Choose <span className="gradient-text">Careerhub</span>?
            </h2>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl overflow-hidden">
                <Image src="/icon.png" alt="Careerhub Logo" width={40} height={40} className="w-full h-full object-cover" />
              </div>
              <span className="text-xl font-bold gradient-text">Careerhub</span>
            </div>
            <p className="text-muted-foreground text-sm">
              © 2024 Careerhub. Built for professionals, by professionals.
            </p>
